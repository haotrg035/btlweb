...
$.fn.validatebox.defaults={required:false,validType:null,validParams:null,delay:200,interval:200,missingMessage:"Trường này là bắt buộc.",invalidMessage:null,tipPosition:"right",deltaX:0,novalidate:false,editable:true,disabled:false,readonly:false,validateOnCreate:true,validateOnBlur:false,events:{focus:_4aa,blur:_4ae,mouseenter:_4b1,mouseleave:_4b4,click:function(e){
var t=$(e.data.target);
...
},message:"Nhập Đúng Định Dạng email VD TT@yahoo.com."},
number:{ validator:function(N_1)
{
	return /^[\\+]?((([0-9]{1,3})([,][0-9]{3})*)|([0-9]+))?([\.]([0-9]+))?$/i.test(N_1);
},message:"Vui lòng nhập số dương"
}
,phone:{ validator:function(P_1)
{
	return  /^0[1-9][0-9][0-9]{7,8}$/i.test(P_1);
},message: "Số điện thoại không đúng"
}
,cmt:{ validator:function(CMT_1)
{
	return  /^[0-9]{9}$/i.test(CMT_1);
},message: "Số chứng minh thư không đúng"},
url:{validator:function(_4d9){
...
length:{validator:function(_4da,_4db){
var len=$.trim(_4da).length;
return len>=_4db[0]&&len<=_4db[1];
},message:"Vui lòng nhập từ {0} đến {1} ký tự."},
remote:{validator:function(_4dc,_4dd){
var data={};
data[_4dd[1]]=_4dc;
var _4de=$.ajax({url:_4dd[0],dataType:"json",data:data,async:false,cache:false,type:"post"}).responseText;
return _4de=="true";
},message:"Vui lòng điền vào trường này"}},onBeforeValidate:function(){
...
$.fn.calendar.defaults={width:180,height:180,fit:false,border:true,showWeek:false,firstDay:0,weeks:["CN","T2","T3","T4","T5","T6","T7"],months:["Tháng 1","Tháng 2","Tháng 3","Tháng 4","Tháng 5","Tháng 6","Tháng 7","Tháng 8","Tháng 9","Tháng 10","Tháng 11","Tháng 12"],year:new Date().getFullYear(),month:new Date().getMonth()+1,current:(function(){
var d=new Date();
